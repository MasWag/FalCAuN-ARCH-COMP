#!/bin/sh -u
#****h* AT/run_falcaun_AT1_constrained
# NAME
#  run_falcaun_AT1_constrained.sh
# DESCRIPTION
#  Script to falsify the AT1 formula by FalCAuN with discontinuity only possible every 5 seconds, i.e., SIGNAL_STEP=5.0
# AUTHOR
#  Masaki Waga
# HISTORY
...
#****if* run_falcaun_AT1_constrained/configuration
# DESCRIPTION
#
# SOURCE
#
...
#****d* run_falcaun_AT1_constrained/configuration
# DESCRIPTION
...
#****d* run_falcaun_AT1_constrained/input_mapper
# DESCRIPTION
...
#****d* run_falcaun_AT1_constrained/signal_name
# DESCRIPTION
#  Name the signal
#
# SOURCE
...
#****d* run_falcaun_AT1_constrained/output_mapper
# DESCRIPTION
...
#****d* run_falcaun_AT1_constrained/stl_file
# DESCRIPTION
#  Define the STL formulas to be falsified
#
# NOTES
#  Since the signal step is 5.0, the time bounds are divided by five, i.e., 20 -> 4.
#
# SOURCE
#
alw_[0, 4] ($speed < 120)
...
#****f* run_falcaun_AT1_constrained/execute
# DESCRIPTION
...
#****** run_falcaun_AT1_constrained/references
# SEE ALSO
