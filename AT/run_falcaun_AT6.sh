#!/bin/sh -u
#****h* transmission/run_falcaun_AT6
# NAME
#  run_falcaun_AT6.sh
# DESCRIPTION
...
#****if* run_falcaun_AT6/configuration
# DESCRIPTION
#
# SOURCE
#
...
#****d* run_falcaun_AT6/configuration
# DESCRIPTION
...
#****d* run_falcaun_AT6/input_mapper
# DESCRIPTION
...
#****d* run_falcaun_AT6/output_mapper
# DESCRIPTION
...
#****d* run_falcaun_AT6/signal_definition
# DESCRIPTION
...
(alw_[0, 15] ($rotation < 3000.0)) -> (alw_[0, 4] ($velocity < 50.0))
(alw_[0, 15] ($rotation < 3000.0)) -> (alw_[0, 10] ($velocity < 65.0))
#******
EOF
