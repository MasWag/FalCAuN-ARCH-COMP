#!/bin/sh -u
#****h* transmission/run_falcaun_AT6c
# NAME
#  run_falcaun_AT6c.sh
# DESCRIPTION
#  Script to falsify the AT6c formula by FalCAuN
# AUTHOR
#  Masaki Waga
# HISTORY
...
#****if* run_falcaun_AT6c/configuration
# DESCRIPTION
#
# SOURCE
#
...
#****d* run_falcaun_AT6c/configuration
# DESCRIPTION
...
#****d* run_falcaun_AT6c/input_mapper
# DESCRIPTION
...
#****d* run_falcaun_AT6c/output_mapper
# DESCRIPTION
...
# SOURCE
#
(alw_[0, 15] (signal(1) < 3000.0)) -> (alw_[0, 10] (signal(0) < 65.0))
#******
EOF
